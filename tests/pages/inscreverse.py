...
class Inscreverse(CadastroLogin):
    def __init__(self, page):
        ...
        self.checkbox_receive_special_offers_from = page.get_by_text("Receive special offers from")
        ...
        self.input_endereco = page.get_by_role("textbox", name="Address * (Street address, P.")
    ...
    def preencher_informacoes_da_conta(self, titulo='', nome='', senha='', data_nascimento='',
    ...
    def preencher_detalhes_de_contato(self, primeiro_nome='', sobrenome='', empresa='', endereco='',
                                  endereco_2='', pais='', estado='', cidade='', zipcode='', numero_telefone=''):
        if primeiro_nome:
